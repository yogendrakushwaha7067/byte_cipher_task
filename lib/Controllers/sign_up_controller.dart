...
class SignUpController extends GetxController {
  signup(
      BuildContext context, String email, String passward, String name) async {
    ...
    var url = Uri.parse(ConstString.baseurl + ConstString.signup);
    var response = await http.post(url,
        body: jsonEncode({"email": email, "password": passward, "name": name}),
